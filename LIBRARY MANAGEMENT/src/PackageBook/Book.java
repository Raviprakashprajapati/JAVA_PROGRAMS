    ...
    public void addBook(int id, String b, String au, int page, int price) {
        ...
        try {
            ...
            if (fp.exists()) {
                ...
                fa.write("\n"+this.BookId + " " + newStr + " " + newStrAuthor + " " + this.BookPages + " " + this.BookPrice
                        + " "+ this.BookAvailable );
                    ...
                    if (scan.hasNextLine()) {
                        ...
                        boolean flag = false;
                            ...
                            if(Integer.parseInt(split[0])==id)
                            {
                                ...
                                System.out.println();
                                System.out.printf("%-10s%-20s%-20s%-15s%-20s%-10s", "I.D", "Book Name", "Book Author",
                        ...
                        if(flag){
                             ...
                             // addind new field
                                ...
                                String updateData = String.format("%d %s %s %d %d %s",ide,name,author,page,price,"YES");
